...
- Update những cập mới nhất từ remote nhưng không merge vào nhánh hiện tại (chỉ tải về commit mới, branch mới, tag mới từ remote):
    * `git fetch origin/upstream`
    * Dùng khi có repo của người khác nhưng bạn muốn lưu về để thay đổi cũng như đồng nhất thông tin mỗi lần repo đó của họ thay đổi.
    * Ví dụ:
